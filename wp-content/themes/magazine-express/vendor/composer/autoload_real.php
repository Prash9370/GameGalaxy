...
class magazine_express_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function magazine_express_loadClassLoader($class)
    {
    ...
    public static function magazine_express_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
