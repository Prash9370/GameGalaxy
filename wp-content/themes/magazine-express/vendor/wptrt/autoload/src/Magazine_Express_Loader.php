...
class Magazine_Express_Loader {
	 ...
	 * @return void
	 */
	public function magazine_express_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function magazine_express_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function magazine_express_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function magazine_express_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->magazine_express_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function magazine_express_load( $class ) {
